...
extern "C" SANITIZER_SECTION(".CRT$XIB") int (*__asan_thunk_init)() =
    asan_thunk_init;
WIN_FORCE_LINK(__asan_thunk_init)

extern "C" SANITIZER_SECTION(".CRT$XLAB") void(WINAPI* __asan_tls_init)(
...
extern "C" SANITIZER_SECTION(".CRT$XCAB") int (*__asan_seh_interceptor)() =
    SetSEHFilter;
