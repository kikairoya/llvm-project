...
#define SANITIZER_INTERCEPT_MEMRCHR (SI_FREEBSD || SI_LINUX || SI_NETBSD || SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_SETPROCTITLE (SI_FREEBSD || SI_NETBSD || SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_GETPWNAM_R_AND_FRIENDS \
  (SI_FREEBSD || SI_NETBSD || SI_MAC || SI_LINUX_NOT_ANDROID || SI_SOLARIS || SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_SETPWENT \
  (SI_MAC || SI_LINUX_NOT_ANDROID || SI_SOLARIS || SI_CYGWIN)
#define SANITIZER_INTERCEPT_CLOCK_GETTIME \
  (SI_FREEBSD || SI_NETBSD || SI_LINUX || SI_SOLARIS || SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_ACCEPT4 \
  (SI_LINUX_NOT_ANDROID || SI_NETBSD || SI_FREEBSD || SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_WCTOMB \
  (SI_FREEBSD || SI_NETBSD || SI_MAC || SI_LINUX_NOT_ANDROID || SI_SOLARIS || SI_CYGWIN)
#define SANITIZER_INTERCEPT_TCGETATTR (SI_LINUX_NOT_ANDROID || SI_SOLARIS || SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_SCHED_GETAFFINITY \
  (SI_LINUX_NOT_ANDROID || SI_FREEBSD || SI_CYGWIN)
#define SANITIZER_INTERCEPT_SCHED_GETPARAM (SI_LINUX_NOT_ANDROID || SI_SOLARIS || SI_CYGWIN)
#define SANITIZER_INTERCEPT_STRERROR SI_POSIX
#define SANITIZER_INTERCEPT_STRERROR_R SI_POSIX
#define SANITIZER_INTERCEPT_XPG_STRERROR_R SI_LINUX_NOT_ANDROID
#define SANITIZER_INTERCEPT_SCANDIR \
  (SI_FREEBSD || SI_NETBSD || SI_LINUX_NOT_ANDROID || SI_SOLARIS || SI_CYGWIN)
#define SANITIZER_INTERCEPT_SCANDIR64 SI_GLIBC || SI_SOLARIS32
#define SANITIZER_INTERCEPT_GETGROUPS SI_POSIX
#define SANITIZER_INTERCEPT_POLL SI_POSIX
#define SANITIZER_INTERCEPT_PPOLL (SI_LINUX_NOT_ANDROID || SI_SOLARIS || SI_CYGWIN)
#define SANITIZER_INTERCEPT_EPOLL (SI_LINUX)
#define SANITIZER_INTERCEPT_KQUEUE (SI_FREEBSD || SI_NETBSD || SI_MAC)
#define SANITIZER_INTERCEPT_WORDEXP                                          \
  (SI_FREEBSD || SI_NETBSD || (SI_MAC && !SI_IOS) || SI_LINUX_NOT_ANDROID || \
   SI_SOLARIS || SI_CYGWIN)
#define SANITIZER_INTERCEPT_SIGWAIT SI_POSIX
#define SANITIZER_INTERCEPT_SIGWAITINFO (SI_LINUX_NOT_ANDROID || SI_SOLARIS || SI_CYGWIN)
#define SANITIZER_INTERCEPT_SIGTIMEDWAIT (SI_LINUX_NOT_ANDROID || SI_SOLARIS || SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_BACKTRACE \
  (SI_FREEBSD || SI_NETBSD || SI_GLIBC || SI_SOLARIS)
#define SANITIZER_INTERCEPT_GETMNTENT (SI_LINUX || SI_CYGWIN)
#define SANITIZER_INTERCEPT_GETMNTENT_R (SI_LINUX_NOT_ANDROID || SI_CYGWIN)
#define SANITIZER_INTERCEPT_STATFS \
    (SI_FREEBSD || SI_MAC || SI_LINUX_NOT_ANDROID || SI_SOLARIS || SI_CYGWIN)
#define SANITIZER_INTERCEPT_STATFS64 \
  ((SI_GLIBC || !SI_NOT_AIX) && SANITIZER_HAS_STATFS64)
#define SANITIZER_INTERCEPT_STATVFS \
  (SI_FREEBSD || SI_NETBSD || SI_LINUX_NOT_ANDROID || SI_CYGWIN)
#define SANITIZER_INTERCEPT_STATVFS64 SI_GLIBC
#define SANITIZER_INTERCEPT_INITGROUPS SI_POSIX
#define SANITIZER_INTERCEPT_ETHER_NTOA_ATON (SI_POSIX && !SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_PTHREAD_MUTEXATTR_GETPROTOCOL \
  (SI_MAC || SI_NETBSD || SI_LINUX_NOT_ANDROID || SI_SOLARIS || SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_PTHREAD_CONDATTR_GETCLOCK \
  (SI_LINUX_NOT_ANDROID || SI_SOLARIS || SI_CYGWIN)
#define SANITIZER_INTERCEPT_PTHREAD_BARRIERATTR_GETPSHARED \
  (SI_LINUX_NOT_ANDROID && !SI_NETBSD)
#define SANITIZER_INTERCEPT_TRYJOIN (SI_GLIBC || SI_CYGWIN)
#define SANITIZER_INTERCEPT_TIMEDJOIN (SI_GLIBC || SI_CYGWIN)
#define SANITIZER_INTERCEPT_THR_EXIT SI_FREEBSD
#define SANITIZER_INTERCEPT_TMPNAM SI_POSIX
#define SANITIZER_INTERCEPT_TMPNAM_R (SI_GLIBC || SI_SOLARIS)
#define SANITIZER_INTERCEPT_PTSNAME (SI_LINUX || SI_CYGWIN)
#define SANITIZER_INTERCEPT_PTSNAME_R (SI_LINUX || SI_CYGWIN)
#define SANITIZER_INTERCEPT_TTYNAME SI_POSIX
#define SANITIZER_INTERCEPT_TTYNAME_R SI_POSIX
#define SANITIZER_INTERCEPT_TEMPNAM SI_POSIX
#define SANITIZER_INTERCEPT_SINCOS (SI_LINUX || SI_SOLARIS || SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_LGAMMAL \
  (SI_POSIX && !SI_NETBSD && SI_NOT_AIX)
#define SANITIZER_INTERCEPT_LGAMMA_R (SI_FREEBSD || SI_LINUX || SI_SOLARIS || SI_CYGWIN)
#define SANITIZER_INTERCEPT_LGAMMAL_R (SI_LINUX_NOT_ANDROID || SI_SOLARIS || SI_CYGWIN)
...
#define SANITIZER_INTERCEPTOR_HOOKS                                            \
  (SI_LINUX || SI_MAC || SI_WINDOWS || SI_CYGWIN || SI_FREEBSD || SI_NETBSD || \
   SI_SOLARIS)
...
#define SANITIZER_INTERCEPT_STAT                                    \
  (SI_FREEBSD || SI_MAC || SI_ANDROID || SI_NETBSD || SI_SOLARIS || \
   SI_CYGWIN || SI_STAT_LINUX || !SI_NOT_AIX)
...
#define SANITIZER_INTERCEPT_UTMPX \
  (SI_LINUX_NOT_ANDROID || SI_MAC || SI_FREEBSD || SI_NETBSD || SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_MALLOPT_AND_MALLINFO \
  (SI_GLIBC || SI_ANDROID || SI_FUCHSIA || SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_SIGNAL_AND_SIGACTION \
  (!SI_WINDOWS && SI_NOT_FUCHSIA && !SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_ACCESS (SI_NETBSD || SI_FREEBSD || SI_CYGWIN)
#define SANITIZER_INTERCEPT_FACCESSAT (SI_NETBSD || SI_FREEBSD || SI_CYGWIN)
#define SANITIZER_INTERCEPT_GETGROUPLIST \
  (SI_NETBSD || SI_FREEBSD || SI_LINUX || SI_CYGWIN)
#define SANITIZER_INTERCEPT_STRLCPY \
  (SI_NETBSD || SI_FREEBSD || SI_MAC || SI_ANDROID || SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_PROTOENT (SI_LINUX || SI_NETBSD || SI_FREEBSD || SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_NL_LANGINFO (SI_NETBSD || SI_FREEBSD || SI_MAC || SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_FUNOPEN (SI_NETBSD || SI_FREEBSD || SI_CYGWIN)
...
#define SANITIZER_INTERCEPT_SIGALTSTACK \
  (SI_POSIX && !(SANITIZER_APPLE && SANITIZER_I386) && !SI_CYGWIN)
