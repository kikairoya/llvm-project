...
extern template class c<double>; // expected-note {{'dllexport' attribute is missing on previous declaration}}
...
// FUNC: define dso_local void @_Z9use_ctorsO1cIsE
// FUNC-O0: declare dllimport{{.*}} void @_ZN1cIsE1fEv
